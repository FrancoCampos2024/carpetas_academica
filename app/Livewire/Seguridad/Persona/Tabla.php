...
class Tabla extends Component
{
    ...
    #[Computed()]
    #[On('refrescar_persona')]
    public function persona()
    {
        return $this->personaService->listarPaginado($this->mostrar_paginate, $this->buscar, 'id_persona', 'desc',[]);
    }
    ...
    public function mount (){
        $this->puedeCrear = Gate::allows('autorizacion', ['CREAR', 'PERSONAS']);
        $this->puedeModificar = Gate::allows('autorizacion', ['MODIFICAR', 'PERSONAS']);
        $this->puedeEliminar = Gate::allows('autorizacion', ['ELIMINAR', 'PERSONAS']);
        $this->puedeCambiarEstado = Gate::allows('autorizacion', ['ESTADO', 'PERSONAS']);
    }
    public function render()
    {
        return view('livewire.seguridad.persona.tabla');
    }
}
