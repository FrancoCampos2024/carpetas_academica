@section('breadcrumb')
    <x-breadcrumb titulo="Gestionar Carpetas">
        <x-breadcrumb.item titulo="Inicio" route="inicio.index" separator />
        <x-breadcrumb.item titulo="Carpetas" />
    </x-breadcrumb>
@endsection

<div>
    {{-- Solo se renderiza si tiene el permiso general de ver el módulo --}}
    @can('autorizacion', ['LISTAR', 'CARPETAS'])
        <livewire:carpeta.tabla-carpetas lazy/>
    @else
