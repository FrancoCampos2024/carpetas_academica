@section('breadcrumb')
<x-breadcrumb titulo="Lista de personas">
    <x-breadcrumb.item titulo="Inicio" route="inicio.index" separator />
    <x-breadcrumb.item titulo="Seguridad" separator />
    <x-breadcrumb.item titulo="Persona" />
</x-breadcrumb>
@endsection

<div>
    @can('autorizacion', ['LISTAR', 'Personas'])
    <livewire:seguridad.persona.tabla lazy/>


    {{-- Modales --}}
    @include('livewire.seguridad.persona.modal-persona')
    @include('livewire.seguridad.persona.modal-estado-persona')
    @include('livewire.seguridad.persona.modal-eliminar-persona')
