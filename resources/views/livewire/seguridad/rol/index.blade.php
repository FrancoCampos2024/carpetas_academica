@section('breadcrumb')
    <x-breadcrumb titulo="Lista de roles">
...
<div>
    ...
    <livewire:seguridad.rol.tabla lazy/>

    {{-- Modales --}}
    @include('livewire.seguridad.rol.modal-rol')
    @include('livewire.seguridad.rol.modal-estado-rol')
    @include('livewire.seguridad.rol.modal-eliminar-rol')
    @else
